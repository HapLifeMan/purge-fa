...
const scanContentInFolder   = process.argv[2]
const fontAwesomeSrcFolder  = process.argv[3]
const fontAwesomeDistFolder = process.argv[4]

// Global array of FA JS files
const faFiles = {
    'fa': {
        input: fontAwesomeSrcFolder + 'solid.js',
        output: fontAwesomeDistFolder + 'solid.js'
    },
    'fal': {
        input: fontAwesomeSrcFolder + 'light.js',
        output: fontAwesomeDistFolder + 'light.js'
    },
    'far': {
        input: fontAwesomeSrcFolder + 'regular.js',
        output: fontAwesomeDistFolder + 'regular.js'
    },
    'fab': {
        input: fontAwesomeSrcFolder + 'brands.js',
...
glob(scanContentInFolder + '**/*.html', {}, function (er, files) {
